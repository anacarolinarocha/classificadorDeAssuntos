...
select_multiclasse="""WITH vs_nivel_assunto as(SELECT b.*,
CASE 
		WHEN b.nivel = '2' THEN 
...
INNER JOIN vs_nivel_assunto va ON pa2.id_assunto_trf = va.id_assunto_trf 
WHERE doc.id_processo IN 
		(SELECT id_processo FROM  
			...
			(SELECT id_processo, count(id_processo_documento) as total_recursos_ordinarios 
			 ...
			 AND dt_juntada < '2015-12-31' AND dt_juntada > '2015-01-01'
