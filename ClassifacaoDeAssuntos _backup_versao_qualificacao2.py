...
from sklearn.model_selection import train_test_split
df_idProcessos_treinamento, df_idProcessos_teste, df_codigoAssunto_treinamento, df_codigoAssunto_teste = train_test_split(df_idProcessos['id_processo_documento'], df_idProcessos['cd_assunto_nivel_2'],
