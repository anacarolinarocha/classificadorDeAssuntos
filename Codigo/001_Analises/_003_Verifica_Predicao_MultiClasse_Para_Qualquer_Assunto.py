...
nome_base_arquivo_predicao = '/media/DATA/classificadorDeAssuntos/Dados/Resultados/EXP24_MelhoresModelos_TextsoReduzidos_TFIDF/predicao_'
...
#     sigla_trt = '22'
    ...
    for index, row in df_processos_preditos_trt_SVM.iterrows():
        # print('----------------------------------------------------------------------')
        ...
        if acertou_predicao_SVM:
            acertou_predicao_SVM = 1
        else:
            acertou_predicao_SVM = 0
        ...
        if assunto_predio_existe_no_processo_SVM:
            assunto_predio_existe_no_processo_SVM = 1
        else:
            assunto_predio_existe_no_processo_SVM = 0


        # print('O assunto predito existe dentre os demais assuntos do processo? ' + str(assunto_predio_existe_no_processo_MLP))
...
path_final =  '/media/DATA/classificadorDeAssuntos/Dados/Resultados/EXP24_MelhoresModelos_TextsoReduzidos_TFIDF/'
