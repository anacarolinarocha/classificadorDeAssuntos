...
classificadorSVM = CalibratedClassifierCV(LinearSVC(class_weight='balanced'),method='sigmoid', cv=5)
...
# for qtdElementosPorAssunto in range(10, 11, 10):
    ...
    param_grid_RF = {
        'estimator__n_estimators': [3],
        'estimator__base_estimator__max_depth': [10,50,100],
        'estimator__base_estimator__n_estimators': [100,200,500],
    ...
    param_grid_MLP = {
        'estimator__n_estimators': [3],
        'estimator__base_estimator__hidden_layer_sizes': [(10,10), (50,100,50), (30,30,30,30),(10,10,10,10,10)],
    ...
    n_iterations_grid_search_MLP = 3
    ...
    param_grid_SVM = {
        ...
        'estimator__max_samples': [round(x_tfidf_train.shape[0] * 0.5),round(x_tfidf_train.shape[0] * 0.3)],
        'estimator__base_estimator__base_estimator__C':[1,10,100,1000],
        'estimator__base_estimator_penalty': ['l1','l2']
    }

    n_iterations_grid_search_SVM = 3
