...
(select a.ds_assunto_trf from tb_assunto_trf a where a.cd_assunto_trf = vs.cd_assunto_nivel_3) as ds_assunto_trf,
count(pa.id_processo_trf)
...
where cd_assunto_nivel_1 = '864'
group by tribunal,vs.cd_assunto_nivel_3,ds_assunto_trf
"""
...
total = df.groupby(['cd_assunto_nivel_3','ds_assunto_trf']).sum()
total.plot(kind='bar')
plt.show()

total.to_csv('/home/anarocha/myGit/classificadorDeAssuntos/Codigo/001_Analises/Outputs/Total_De_Processos_Por_Nivel_3_Assunto_Principal.csv')
