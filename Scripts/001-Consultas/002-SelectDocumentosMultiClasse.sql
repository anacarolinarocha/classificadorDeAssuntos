...
INNER JOIN processos_retificados pret ON pa2.id_processo_trf = pret.id_processo_trf
INNER JOIN vs_nivel_assunto va ON pa2.id_assunto_trf = va.id_assunto_trf AND va.cd_assunto_nivel_3 in ('5280','5288','5294','1806','1844','2029','2554','1690','1773','4437','1663','2086','1661','2139','2140','10581','2021','2583','2594','2506','1767','1783','1888','2055','2215','55170','2458','2117','1904','1907','2656','2435','2546','8808','1855','55220','2704')
