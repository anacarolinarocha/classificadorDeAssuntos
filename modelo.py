...
class Modelo:
    ...
    def getMacroPrecision(self, macro_precision):
        return macro_precision 
     
    def getMacroRecall(self, macro_recall):
        return macro_recall 
        
    def getMacroFscore(self, macro_fscore):
        return macro_fscore 
        
    def getMicroPrecision(self, micro_precision):
        return micro_precision 
     
    def getMicroRecall(self, micro_recall):
        return micro_recall 
        
    def getMicroFscore(self, micro_fscore):
        return micro_fscore 
